      ...
      >
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/20"
            required
          />
        </div>
        <div className="flex flex-col gap-1">
        ...
        <div>
          {chapters.map((chapter, chapterIndex) => (
            ...
            >
              <div
                className={`flex justify-between items-center border-gray-500/20 ${!chapter.collapsed && "border-b"} p-4`}
              >
